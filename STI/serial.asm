...
_SEND				    ;SUBROTINA QUE RECEBE O SÍMBOLO A SER COMUNICADO EM WORK, O ENCAPSULA COM OS BITS DE INICIO, PARIDADE E FIM DE TRANSMISSÃO DE ACORDO COM O PROTOCOLO RS232 PARA COMUNICAÇÃO SERIAL DE APROXIMADAMENTE 115200 BAUS
	...
	ANDLW	B'00000000'	    ;LIMPA WORK, DE FORMA A PERMITIR A IMPLEMENTAÇÃO CORRETA DO BIT DE PARIDADE DA COMUNICAÇÃO SERIAL
	NOP
	NOP
	NOP
	NOP
	...
	BCF	STATUS, 0	    ;LIMPA O CARRY, DE FORMA COM QUE A ROTAÇÃO PARA A DIREITA DE WORD INSIRA O VALOR 0 NO NOVO MSB.
	...
	XORLW	B'00100000'	    ;CASO O BIT 0 DE WORD ESTEJA "SETTADO", MUDA O VALOR DO BIT 5 DE WORK, QUE REPRESENTA A PARIDADE DA QUANTIDADE DE 1s NO SIMBOLO ENVIADO, POR MEIO DA OPERAÇÃO DE OU EXCLUSIVO BIT A BIT COM O VALOR '00100000', MANTENDO TODOS OS OUTROS BITS DE WORK INALTERADOS. 
	RRF	WORD, 1		    ;ROTACIONA 1, PARA QUE O NOVO LSB DE WORD, QUE SERÁ VERFICADO NA PROXIMA ITERAÇÃO, ASSUMA O VALOR CORRETO.
	DECFSZ	COUNTER		    ;DECREMETNA COUNTER, DE FORMA COM QUE ELE INDIQUE QUANTAS ITERAÇÕES FALTAM PARA O TERMINO DO ENVIO DO SIMBOLO.
	GOTO	_NEXT		    ;CASO COUNTER NÃO SEJA 0, VAI PARA A PROXIMA ITERAÇÃO
	NOP
	...
	NOP
	NOP
	MOVWF	GPIO		    ;MOVE O VALOR DE WORK PARA GPIO. COMO APENAS GP5 É CONFIGURADO COMO OUTPUT, APENAS ESTE PINO É AFETADO, RECEBENDO O VALOR DO BIT DE PARIDADE
	NOP
	NOP
	NOP
	NOP
